...
def train(trial_run=False):
    ...
    for val_sub in all_subjects:
        ...
        val_loader_stage1 = DataLoader(val_ds_stage1, batch_size=128, shuffle=False, num_workers=0, pin_memory=False)
        
        train_loader_stage2 = DataLoader(train_ds_stage2, batch_size=128, shuffle=True, num_workers=0, pin_memory=False)
        val_loader_stage2 = DataLoader(val_ds_stage2, batch_size=128, shuffle=False, num_workers=0, pin_memory=False)
        
        val_loader_all = DataLoader(val_ds_all, batch_size=128, shuffle=False, num_workers=0, pin_memory=False)
